...
<acme:form>
	...
	<acme:form-textbox code="administrator.configuration.form.label.ratioOfJobsThatHaveABisit" path="ratioOfJobsThatHaveABisit" readonly="true"/>
	<acme:form-textbox code="administrator.configuration.form.label.ratioOfBisitsThatHaveATracer" path="ratioOfBisitsThatHaveATracer" readonly="true"/>
	<acme:form-textbox code="administrator.configuration.form.label.ratioOfApplicationsThatHaveAPasswordProtectedTracer" path="ratioOfApplicationsThatHaveAPasswordProtectedTracer" readonly="true"/>
