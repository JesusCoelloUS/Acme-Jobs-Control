...
@Service
public class EmployerBisitUpdateService implements AbstractUpdateService<Employer, Bisit> {
	...
	@Override
	public void update(final Request<Bisit> request, final Bisit entity) {
		assert request != null;
		assert entity != null;
